...
module.exports = {
    ...
    facebookFail: async (req, res) => {
        res.send({ ...context, success: true, message: 'Login failed' });
    },

    facebookSuccess: async (req, res) => {
        return res.json(({ ...context, success: true, message: 'Login successful' }))
